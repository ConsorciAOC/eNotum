...
Dades d'ofici de la notficiació consulta, es descriu amb més detall a [continuació](https://github.com/ConsorciAOC/eNotum/blob/master/missatgeria/README.MD#dadesofici)
